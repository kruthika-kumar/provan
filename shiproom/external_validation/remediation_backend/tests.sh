...
[[ "$(quota_limit_kib 8589934592)" == 8388608k ]]; [[ "$(quota_limit_kib 1048576)" == 1024k ]]; ! quota_limit_kib 1; ! quota_limit_kib 01024
...
truncate -s 16G "$IMAGE"; control_init; capacity=$(capacity_record_from_xfs)
