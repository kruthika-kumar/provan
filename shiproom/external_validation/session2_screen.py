...
def _candidate_from_index(directory: Path, *, candidate_id: str, candidate_index_hash: str) -> dict[str, Any]:
    ...
    if (index.get("schema_id") not in {"external_validation.session2_github_issue_fix_candidate_index.v1", "external_validation.session2_github_issue_fix_candidate_index.v2", "external_validation.session2_github_issue_fix_candidate_index.v3", "external_validation.session2_fresh_b_candidate_index.v1"}
