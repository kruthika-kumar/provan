...
CLAIMS=(
 ...
 {"claim_id":"read_only_operation","implementation_refs":["shiproom.measurement_ai.persistence.compile_generation","shiproom.measurement_ai.authority.reject_external_operation"],"positive_test_ids":["test_domain_core_records_zero_external_operations"],"negative_test_ids":["test_each_prohibited_external_operation_is_attempted_rejected_and_side_effect_free"],"artifact_assertions":[{"artifact":"measurement-ai-compiler-receipts.json","assertion":"all_external_operations_zero","minimum_records":6}]},
 ...
 {"claim_id":"production_boundary_parity","implementation_refs":["shiproom.measurement_ai.contract_parity.parity_report","shiproom.measurement_ai.contract_parity.private_rubric_parity"],"positive_test_ids":["test_production_boundary_parity_executes_all_27_contracts"],"negative_test_ids":["test_production_boundary_report_rejects_unexecuted_or_passing_mutation"],"artifact_assertions":[{"artifact":"contract-parity-report.json","assertion":"all_portable_boundaries_executed","minimum_records":27},{"artifact":"private-rubric-parity-report.json","assertion":"private_rubric_mutations_rejected","minimum_records":3}]},
)
