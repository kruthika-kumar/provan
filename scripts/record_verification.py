...
def main() -> int:
    ...
    if evals != 14: raise SystemExit(f"expected 14 evals, observed {evals}")
    ...
    verified.update({"tests_passed":int(match.group(1)),"evals_passed":evals,"policy_gate":"passed","policy_version":POLICY_VERSION,"eval_version":EVAL_VERSION,"rollback_baseline_version_id":args.cloudflare_version,"pr2_url":"https://github.com/kruthika-kumar/shiproom/pull/2"})
