...
SUPPLEMENTAL_CLAIM_INVARIANTS={
 1:{"seed_disposition_contract","contract_provenance_binding","disposition_semantic_binding"},2:{"disposition_semantic_binding"},14:{"contract_provenance_binding","disposition_semantic_binding"},16:{"seed_disposition_contract","disposition_semantic_binding"},17:{"seed_disposition_contract","disposition_semantic_binding"},18:{"seed_disposition_contract","disposition_semantic_binding"},19:{"disposition_semantic_binding"},
 ...
 75:{"controlled_reinspection_binding"},76:{"record_rendering_surface"},79:{"contract_provenance_binding"},80:{"attestation_complete_binding"},85:{"record_projection_authority"},
}
