...
SUPPLEMENTAL_CLAIM_INVARIANTS={
 1:{"seed_disposition_contract","contract_provenance_binding"},14:{"contract_provenance_binding"},16:{"seed_disposition_contract"},17:{"seed_disposition_contract"},18:{"seed_disposition_contract"},
