...
INVARIANTS=[
 ...
 ("S11A","contract_provenance_binding","acceptance-contract.v1.json","test_proof_contract_provenance_layers",{"adversarial":"CONTRACT_PREDECESSOR_BINDING_MISMATCH","schema-valid-python-invalid":"CONTRACT_PROVENANCE_INVALID"}),
 ("S11A","disposition_semantic_binding","seed-disposition.v1.json","test_proof_contract_disposition_semantics_layers",{"adversarial":"CONTRACT_DISPOSITION_SEMANTICS_MISMATCH","schema-valid-python-invalid":"CONTRACT_DISPOSITION_SEMANTICS_MISMATCH"}),
 ("S11A","risk_authority_binding","acceptance-contract.v1.json","test_proof_contract_risk_authority_layers",{"adversarial":"RISK_AUTHORITY_INVALID","schema-valid-python-invalid":"RISK_AUTHORITY_INVALID"}),
 ...
 ("S11C","external_change_receipt_contract","external-change-receipt.v1.json",{"valid":"test_proof_support_contract_layers[external-valid]","near-valid":"test_proof_support_contract_layers[external-near-valid]","adversarial":"test_reinspect_rejects_semantically_invalid_external_receipt_before_storage","schema-invalid":"test_proof_support_contract_layers[external-schema-invalid]","schema-valid-python-invalid":"test_proof_support_contract_layers[external-schema-valid-python-invalid]"},{"adversarial":"EXTERNAL_CHANGE_RECEIPT_CLOSURE_AUTHORITY_FORBIDDEN","schema-valid-python-invalid":"EXTERNAL_CHANGE_RECEIPT_CLOSURE_AUTHORITY_FORBIDDEN"}),
 ...
 ("S11J","owner_decision_compatibility","owner-decision.v1.json","test_proof_owner_decision_layers",{"adversarial":"OWNER_DECISION_INCOMPATIBLE","schema-valid-python-invalid":"OWNER_DECISION_ACTOR_AUTHORITY_INVALID"}),
 ...
 ("S11P","session11_capability_unreachability","session10-runtime-invariant-evidence.v1.json","test_proof_session11_capability_unreachability_layers",{"adversarial":"SESSION11_FORBIDDEN_CAPABILITY_REACHABLE"}),
 ("S11P","topology_overlay_absence","session10-runtime-invariant-evidence.v1.json","test_proof_topology_overlay_absence_layers",{"adversarial":"SESSION11_TOPOLOGY_OVERLAY_UNSUPPORTED"}),
 ("S11Q","session12_handoff_completeness","session12-handoff.v1.json","test_proof_session12_handoff_layers",{"adversarial":"SESSION12_HANDOFF_DUPLICATE_ARTIFACT_REF","schema-valid-python-invalid":"SESSION12_HANDOFF_VERIFIER_CONTRACT_SET_MISMATCH"}),
...
CLAIM_INVARIANTS={"contract_surface":{1,2,16,17,18,19,20,21,66,79},"conditional_activation":{3,22,23,68,69,81},"contract_supersession":{70},"verifier_work_order_contract":{4,27},"verifier_capability_contract":{5,28},"verification_result_contract":{6,29},"environment_receipt_contract":{7},"command_receipt_contract":{8,30},"external_change_receipt_contract":{12,51},"semantic_validator_coverage":{14},"typed_closure_checks":{24,25,26,83},"human_confirmation":{84},"attestation_chain":{37,38,39,40,80},"evidence_ingestion_authority":{31,32,33,34,35,36,71,82},"settlement_recommendation":{9,41},"disputed_derivation":{72},"owner_decision_compatibility":{11,42,43,44,73},"protected_invariant_contract":{10,67},"reinspection_lineage":{13,52,53,54,74,75},"reinspection_aggregate":{86},"protected_invariant_closure":{87},"expiry_effective_status":{77},"future_capability_ceiling":{45,55,56,60},"session11_capability_unreachability":{57},"topology_overlay_absence":{49},"session12_handoff_completeness":{15,58,59,61,62,63,64,65},"pr_history_safety":{78},"record_projection_authority":{46,47,48,50,76,85}}
SUPPLEMENTAL_CLAIM_INVARIANTS={
 1:{"seed_disposition_contract","contract_provenance_binding","disposition_semantic_binding"},2:{"disposition_semantic_binding","risk_authority_binding"},14:{"contract_provenance_binding","disposition_semantic_binding","risk_authority_binding"},16:{"seed_disposition_contract","disposition_semantic_binding"},17:{"seed_disposition_contract","disposition_semantic_binding"},18:{"seed_disposition_contract","disposition_semantic_binding"},19:{"disposition_semantic_binding"},21:{"risk_authority_binding"},
 ...
 75:{"controlled_reinspection_binding"},76:{"record_rendering_surface"},79:{"contract_provenance_binding","risk_authority_binding"},80:{"attestation_complete_binding"},85:{"record_projection_authority"},
}
...
def main():
    ...
    for row in authority["claims"]:
        ...
        proofs={fixture:list(dict.fromkeys(proof_set.get(fixture,"NOT_APPLICABLE:RUNTIME_BEHAVIORAL_INVARIANT") for proof_set in proof_sets)) for fixture in ("valid","near-valid","adversarial","schema-valid-python-invalid","schema-invalid")}
