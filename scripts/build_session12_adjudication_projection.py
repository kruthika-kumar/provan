...
def main() -> int:
    ...
    registry_path = private / "frozen_case_registry.v1.private.json"; source_path = private / "source_snapshot_manifest.v1.private.json"; policy_path = private / "evaluation_policy.v9.private.json"; review_path = private / "adjudication_review_receipt.v5.private.json"; ledger_path = private / "foundry_qualified_model_arms.v5.private.json"; scoring_path = private / "foundry_qualified_model_scoring.v4.private.json"
