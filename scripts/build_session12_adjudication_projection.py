...
def main() -> int:
    ...
    registry_path = private / "frozen_case_registry.v1.private.json"; source_path = private / "source_snapshot_manifest.v1.private.json"; policy_path = private / "evaluation_policy.v4.private.json"; review_path = private / "adjudication_review_receipt.v2.private.json"; ledger_path = private / "foundry_qualified_model_arms.v2.private.json"; scoring_path = private / "foundry_qualified_model_scoring.v1.private.json"
    ...
    if policy.get("version")!=4 or review.get("result")!="GO" or review.get("evaluation_policy_sha256")!=file_sha(policy_path) or ledger.get("evaluation_policy_sha256")!=file_sha(policy_path) or scoring.get("evaluation_policy_sha256")!=file_sha(policy_path) or scoring.get("model_arms_ledger_sha256")!=file_sha(ledger_path):raise SystemExit("SESSION12_PRIVATE_PROJECTION_BINDING_INVALID")
