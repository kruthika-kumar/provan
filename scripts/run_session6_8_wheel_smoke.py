...
def main() -> int:
    ...
    if detail.is_file():
        ...
        receipt.update({key: details[key] for key in ("installed_distribution", "wheel_sha256", "bundled_wheel_path", "shiproom_executable", "shiproom_module_path", "site_packages_root", "source_checkout_not_on_sys_path", "external_working_directory", "artifacts")})
